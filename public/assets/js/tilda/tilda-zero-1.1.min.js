function t396_init(t) {
    ...
    d && (t396_initTNobj(t, d), n = t396_detectResolution(t), e = document.getElementById("allrecords"), window.tn_window_width = document.documentElement.clientWidth, o = "ab" + t, window.tn[o].scaleFactor = parseFloat((window.tn_window_width / n)
        .toFixed(3)), window.tn_scale_factor = parseFloat((window.tn_window_width / n)
        .toFixed(3)), t396_switchResolution(t, n), t396_updateTNobj(t), t396_artboard_build("", t), i = "ontouchend" in document, window.addEventListener("resize", function() {
        tn_console(">>>> t396: Window on Resize event >>>>"), d.classList.add("t396_resizechange"), t396_waitForFinalEvent(function() {
        ...
        var t = d ? window.getComputedStyle(d)
        ...
        t396_allelems__renderView(d), t396_doResize(t)
    }), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && r && r.classList.add("t396_safari"), n = "window" === t396_ab__getFieldValue(d, "upscale"), o = e ? "edit" === e.getAttribute("data-tilda-mode") : null, n && !o && t_onFuncLoad("t396_scaleBlock", function() {
        t396_scaleBlock(t)
    }), o || "y" !== t396_ab__getFieldValue(d, "fixed-need-js") || t_onFuncLoad("t396__processFixedArtBoard", function() {
        t396__processFixedArtBoard(d)
    }), o && r && d && (o = d.getAttribute("data-artboard-ovrflw"), r.style.position = "relative", r.style.zIndex = "auto" === o || "visible" === o ? "2" : "1"))
}
...
function t396_doResize(t) {
    ...
    t396_removeElementFromDOM(i ? i.querySelector(".t396__scale-style") : null), e ? (e = i ? i.querySelectorAll(".tn-atom") : [], Array.prototype.forEach.call(e, function(t) {
        var e = t.closest(".tn-atom__scale-wrapper"),
            i = e ? e.parentNode : null;
        i && i.removeChild(e), i && i.appendChild(t)
    })) : (r = i ? i.querySelectorAll(".t396__elem") : [], Array.prototype.forEach.call(r, function(t) {
        t.style.zoom = "";
        t = t.querySelector(".tn-atom");
        t && (t.style.transformOrigin = "", t.style.fontSize = "", t.style.webkitTextSizeAdjust = "")
    }));
    var a = i ? i.querySelector(".t396__artboard") : null,
        r = "ab" + t,
        i = a ? a.clientWidth : 0;
    window.tn_window_width = document.documentElement.clientWidth, window.tn[r].scaleFactor = parseFloat((window.tn_window_width / o)
        .toFixed(3)), window.tn_scale_factor = parseFloat((window.tn_window_width / o)
        .toFixed(3)), window.tn_scale_offset = (i * window.tn_scale_factor - i) / 2, t396_switchResolution(t, o), t396_updateTNobj(t), t396_ab__renderView(a);
    n = n ? n.getAttribute("data-tilda-mode") : "";
    "window" === t396_ab__getFieldValue(a, "upscale") && "edit" !== n && t_onFuncLoad("t396_scaleBlock", function() {
        t396_scaleBlock(t)
    }), "edit" !== n && "y" === t396_ab__getFieldValue(a, "fixed-need-js") && t_onFuncLoad("t396__processFixedArtBoard", function() {
...
function t396_detectResolution(t) {
    if(t) {
        var e, t = "ab" + t,
            i = window.innerWidth;
        return (window.t396__isMobile || "ontouchend" in document && -1 !== navigator.userAgent.indexOf("AppleWebKit")) && (i = document.documentElement.clientWidth), window.tn[t].screens.forEach(function(t) {
            t <= i && (e = t)
        }), void 0 === e && (e = window.tn[t].screens[0]), e
    }
}
...
function t396_setScreensTNobj(t, e) {
    ...
    e = e.getAttribute("data-artboard-screens");
    e ? (e = e.split(","))
        .forEach(function(t) {
...
function t396_updateTNobj(t) {
    ...
    var e = "ab" + t,
        ...
        n = i && window.getComputedStyle(i)
        .paddingLeft || "0",
        n = parseInt(n, 10),
        t = i && window.getComputedStyle(i)
        .paddingRight || "0",
        t = parseInt(t, 10);
    window.zero_window_width_hook && "allrecords" === window.zero_window_width_hook && i ? window.tn.window_width = i.clientWidth - (n + t) : window.tn.window_width = document.documentElement.clientWidth, window.tn.window_height = window.t396__isMobile ? document.documentElement.clientHeight : window.innerHeight;
    for(var o = window.tn[e].screens.slice()
            .reverse(), a = 0; a < o.length; a++) window.tn[e].curResolution === o[a] && (window.tn[e].canvas_min_width = o[a], window.tn[e].canvas_max_width = 0 === a ? window.tn.window_width : o[a - 1]);
...
function t396_switchResolution(t, e) {
    ...
    var i = "ab" + t,
        t = window.tn[i].screens[window.tn[i].screens.length - 1];
    window.tn[i].curResolution = e, window.tn[i].curResolution_max = t, window.tn.curResolution = e, window.tn.curResolution_max = t
}
...
function t396_artboard_build(t, e) {
    ...
    a.initEvent("artBoardRendered", !0, !0);
    t = o.querySelectorAll(".tn-elem");
    ...
    }), o.classList.remove("rendering"), o.classList.add("rendered"), o.dispatchEvent(a);
    var r, a = o.getAttribute("data-artboard-ovrflw");
    "visible" !== a && "visibleX" !== a || !n || (n.style.overflow = "hidden"), "auto" !== a || 0 !== (r = Math.abs(o.offsetHeight - o.clientHeight)) && (o.style.paddingBottom = r + "px"), (window.t396__isMobile || "ontouchend" in document && -1 !== navigator.userAgent.indexOf("AppleWebKit")) && ((r = document.createElement("style"))
        .textContent = "@media only screen and (min-width:1366px) and (orientation:landscape) and (-webkit-min-device-pixel-ratio:2) {.t396__carrier {background-attachment:scroll!important;}}", i.insertAdjacentElement("beforeend", r))
}
...
function t396_ab__renderView(t) {
    ...
    var o, a, r = t396_ab__getFieldValue(t, "height"),
        ...
        l = !!i && "edit" === i.getAttribute("data-tilda-mode"),
        _ = "window" === t396_ab__getFieldValue(t, "upscale"),
        i = t396_ab__getFieldValue(t, "height_vh");
    if(_ && !l && i && (o = parseInt(r, 10) * window.tn_scale_factor), r === d || o && d <= o) a = 0;
    else switch(t396_ab__getFieldValue(t, "valign")) {
        case "top":
            a = 0;
            break;
        case "center":
            a = o ? parseFloat(((d - o) / 2)
                .toFixed(1)) : parseFloat(((d - r) / 2)
                .toFixed(1));
            break;
        case "bottom":
            a = o ? parseFloat((d - o)
                .toFixed(1)) : parseFloat((d - r)
                .toFixed(1));
            break;
        case "stretch":
            a = 0, r = d;
    ...
    _ = t.querySelector(".t396__filter"), l = t.querySelector(".t396__carrier");
    i = t396_ab__getFieldValue(t, "height_vh"), i = parseFloat(i), window.t396__isMobile && i && (i = document.documentElement.clientHeight * i / 100, t.style.height = i + "px", _ && (_.style.height = i + "px"), l && (l.style.height = i + "px"))
}
...
function t396_addShape(t, e) {
    (e = t396_getEl(e)) && (tn_console("func: addShape"), e.setAttribute("data-fields", "width,height,top,left,container,axisx,axisy,widthunits,heightunits,leftunits,topunits"), t396_elem__renderView(e), t396_processShapeTransform(e))
}

function t396_processShapeTransform(t) {
    var e, i = getComputedStyle(t);
    (i.backdropFilter && "none" !== i.backdropFilter || i.webkitBackdropFilter && "none" !== i.webkitBackdropFilter) && ("matrix(1, 0, 0, 1, 0, 0)" === (i = (e = t.querySelector(".tn-atom")) ? window.getComputedStyle(e)
        .transform : "none") && (i = "none"), "none" !== i && (e.style.transform = "none", t.style.transform = i))
}

function t396_changeFilterOnSafari(t, n) {
    var e;
    !/^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (e = window.getComputedStyle(t)
            .webkitBackdropFilter) && "none" !== e && "IntersectionObserver" in window && new IntersectionObserver(function(t, i) {
...
function t396_WaitForUploadImg(t, e) {
    var i;
    "y" === window.lazy ? i = setTimeout(function() {
...
function t396_addButton(t, e) {
    if(e = t396_getEl(e)) {
        ...
        return e.setAttribute("data-fields", "top,left,width,height,container,axisx,axisy,caption,leftunits,topunits"), t396_elem__renderView(e), e
    }
}
...
function t396_elem__setFieldValue(t, e, i, n, o, a) {
    ...
    (t = t396_getEl(t)) && (r = "ab" + t.closest(".t396__artboard")
        .getAttribute("data-artboard-recid"), +(a = a || window.tn[r].curResolution) < window.tn[r].curResolution_max && "zindex" !== e ? t.setAttribute("data-field-" + e + "-res-" + a + "-value", i) : t.setAttribute("data-field-" + e + "-value", i), "render" === n && elem__renderViewOneField(t, e), "updateui" === o && panelSettings__updateUi(t, e, i))
}
...
function t396_elem__getFieldValue(t, e) {
    if(t = t396_getEl(t)) {
        var i = t.closest(".t396__artboard"),
            ...
            o = "ab" + n;
        void 0 === window.tn[o] && (t396_initTNobj(n, i), t396_switchResolution(n, t396_detectResolution(n)));
...
function t396_elem__renderViewOneField(t, e) {
    if(t = t396_getEl(t)) {
        var i = document.getElementById("allrecords"),
            n = i ? i.getAttribute("data-tilda-mode") : "",
            i = "window" === t396_ab__getFieldValue(t.closest(".t396__artboard"), "upscale");
        if("yes" !== t.getAttribute("data-scale-off") || !i || "edit" === n) {
            var o, a, r, d, l, _ = t396_elem__getFieldValue(t, e);
            switch(e) {
                case "left":
                    _ = t396_elem__convertPosition__Local__toAbsolute(t, e, _), t.style.left = parseFloat(_)
                        .toFixed(1) + "px";
                    break;
                case "top":
                    _ = t396_elem__convertPosition__Local__toAbsolute(t, e, _), t.style.top = parseFloat(_)
                        .toFixed(1) + "px";
                    break;
                case "width":
                    switch(_ = t396_elem__getWidth(t, _), t.style.width = parseFloat(_)
                        .toFixed(1) + "px", c = t.getAttribute("data-elem-type")) {
                        case "tooltip":
                            ...
                            Array.prototype.forEach.call(s, function(t) {
                                ...
                                }), t.style.height = parseInt(_)
                                .toFixed(1) + "px";
                            break;
                        case "gallery":
                            o = t396_elem__getFieldValue(t, "borderwidth"), (a = t396_elem__getFieldValue(t, "borderstyle")) && o && "none" !== a || (o = 0), _ -= 2 * o, r = parseFloat(_)
                                .toFixed(1) + "px", d = t.querySelector(".t-slds__main"), l = t.querySelectorAll(".tn-atom__slds-img"), t.style.width = r, d && (d.style.width = r), Array.prototype.forEach.call(l, function(t) {
                                    t.style.width = r
                                })
                    }
                    break;
                case "height":
                    ...
                    _ = t396_elem__getHeight(t, _), t.style.height = parseFloat(_)
                        .toFixed(1) + "px", "gallery" === c && (o = t396_elem__getFieldValue(t, "borderwidth"), (a = t396_elem__getFieldValue(t, "borderstyle")) && o && "none" !== a || (o = 0), _ -= 2 * o, r = parseFloat(_)
                            .toFixed(1) + "px", d = t.querySelector(".t-slds__main"), l = t.querySelectorAll(".tn-atom__slds-img"), t.style.height = r, d && (d.style.height = r), Array.prototype.forEach.call(l, function(t) {
                                t.style.height = r
                            }));
                    break;
                case "container":
...
function t396_elem__convertPosition__Local__toAbsolute(t, e, i) {
    if(t = t396_getEl(t)) {
        ...
        switch(i = parseInt(i), e) {
            ...
            case "top":
                var b = t.parentNode;
                b.classList.contains("t396__artboard") || (b = b.parentNode);
                var p = b ? b.getAttribute("data-artboard-proxy-min-offset-top") : "0",
                    y = b ? b.getAttribute("data-artboard-proxy-min-height") : "0",
                    h = b ? b.getAttribute("data-artboard-proxy-max-height") : "0",
                    m = function(t) {
                ...
                f = "grid" === g ? "grid" : "window", v = "grid" === g ? parseFloat(p) : 0, p = "grid" === g ? parseFloat(y) : parseFloat(h), "%" === t396_elem__getFieldValue(t, "topunits") && (i = p * (i / 100)), s && "window" !== f && (i *= window.tn_scale_factor), c && "window" !== f && (v = "stretch" === r ? 0 : v / window.tn_scale_factor), i = v + i;
                var F, y = t396_ab__getFieldValue(b, "height_vh"),
                    h = t396_ab__getFieldValue(b, "height"),
                    v = t396_ab__getHeight(b);
...
function t396_elem_fixLineHeight(t) {
    var e, i, n, o;
    "text" !== t.getAttribute("data-elem-type") || (e = t.querySelector(".tn-atom")) && (i = /^((?!chrome|android).)*safari/i.test(navigator.userAgent), n = t.style.zoom, e.style.removeProperty("line-height"), o = parseFloat(window.getComputedStyle(e)
        .lineHeight), i && n && (o = t396_elem__getCorrectStylesForSafari(t, "lineHeight")), o && !isNaN(o) && (e.style.lineHeight = Math.round(o) + "px"))
}
...
function t396_elem__getCorrectStylesForSafari(t, e) {
    var i = t.querySelector(".tn-atom"),
        ...
        a = i.style.fontSize;
    i.style.webkitTextSizeAdjust = "none", i.style.fontSize = "", t.style.zoom = "";
    e = parseFloat(window.getComputedStyle(i)[e]);
...
function t396_ab__getFieldValue(t, e) {
    if(t) {
        var i = t.getAttribute("data-artboard-recid"),
            n = "ab" + i;
        void 0 === window.tn[n] && (t396_initTNobj(i, t), t396_switchResolution(i, t396_detectResolution(i)));
        var o, a = window.tn[n].curResolution,
            r = window.tn[n].curResolution_max,
            d = window.tn[n].screens;
        if(null === (o = a === r ? t.getAttribute("data-artboard-" + e) : t.getAttribute("data-artboard-" + e + "-res-" + a)))
            for(var l = 0; l < d.length; l++) {
                var _ = d[l];
                if(!(_ <= a) && null !== (o = _ === r ? t.getAttribute("data-artboard-" + e) : t.getAttribute("data-artboard-" + e + "-res-" + _))) break
            }
        return o
    }
}
...
function t396_ab__filterUpdate(t) {
    var e, i, n, o = t.querySelector(".t396__filter");
    o && (e = o.getAttribute("data-filtercolor-rgb"), i = o.getAttribute("data-filtercolor2-rgb"), n = o.getAttribute("data-filteropacity"), t = o.getAttribute("data-filteropacity2"), e && !i ? o.style.backgroundColor = "rgba(" + e + "," + n + ")" : !e && i ? o.style.backgroundColor = "rgba(" + i + "," + t + ")" : e && i ? o.style.background = "-webkit-gradient(linear, left top, left bottom, from(rgba(" + e + "," + n + ")), to(rgba(" + i + "," + t + ")) )" : o.style.backgroundColor = "transparent")
}

function t396_ab__getHeight(t, e) {
    e = e || t396_ab__getFieldValue(t, "height"), e = parseFloat(e);
    t = t396_ab__getFieldValue(t, "height_vh");
...
function t396_elem__getWidth(t, e) {
    var i = "ab" + (t = t396_getEl(t))
        .closest(".t396__artboard")
        .getAttribute("data-artboard-recid");
    return e = e || t396_elem__getFieldValue(t, "width"), e = parseFloat(e), "%" === t396_elem__getFieldValue(t, "widthunits") && (e = "window" === t396_elem__getFieldValue(t, "container") ? window.tn.window_width * e / 100 : window.tn[i].grid_width * e / 100), e
}
...
function t396_hex2rgba(t, e) {
    if(!t) return !1;
    var i = t.replace(/#/, "");
    3 === i.length && (t = "#" + i[0] + i[0] + i[1] + i[1] + i[2] + i[2]);
    t = parseInt(t.substring(1), 16);
    return [(16711680 & t) >> 16, (65280 & t) >> 8, 255 & t, parseFloat(e)]
}
